...
const recetteBg = require('@/assets/images/recipes/recetteBg.png');
const badgeimage = require('@/assets/images/recipes/badge.png');
...
const RecipeDetails = ({ recipe = {}, custom = true }: RecipeDetailsProps) => {
  ...
  <View style={[styles.recipeImage, { backgroundColor: '#ccc' }]} />
)}
